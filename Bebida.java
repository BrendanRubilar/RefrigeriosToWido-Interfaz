...
class Fanta extends Bebida {
    ...
    public Fanta(int X, JPanel target, int serie) {
        ...
        lataFanta.setIcon(new ImageIcon(imagenLataFanta.getImage().getScaledInstance(lataFanta.getWidth(),
        lataFanta.getHeight(), Image.SCALE_SMOOTH)));
...
class Sprite extends Bebida {
    ...
    public Sprite(int X, JPanel target, int serie) {
        ...
        lataSprite.setIcon(new ImageIcon(imagenLataSprite.getImage().getScaledInstance(lataSprite.getWidth(),
                lataSprite.getHeight(), Image.SCALE_SMOOTH)));
...
class CocaCola extends Bebida {
    ...
    public CocaCola(int X, JPanel target, int serie) {
        ...
        lataCoca.setIcon(new ImageIcon(imagenLataCoca.getImage().getScaledInstance(lataCoca.getWidth(),
                lataCoca.getHeight(), Image.SCALE_SMOOTH)));
        target.add(lataCoca);
