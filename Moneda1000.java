...
class Moneda1000 extends Moneda{
   ...
   JLabel moneda1000;
   int serie;
   public Moneda1000(JPanel target, Billetera billetera, Expendedor expendedor,int serie,int auxiliar){
      this.serie = serie;
      //Pruebas moneda de 1000
      moneda1000 = new JLabel();
      ImageIcon imagen1000 = new ImageIcon("1000chelines.png");
      if(auxiliar==0) moneda1000.setBounds(660,470,50,50);
      if(auxiliar==1) moneda1000.setBounds(420,485,50,50);
